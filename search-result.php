...
<head>
        ...
        <title>Search Result - ANISH Fashion Store</title>
    </head>
    <body>
    ...
    <div class="header-top">
        ...
        <div class="container">
            <div class="banner-header banner-lbook3 space-40">
                ...
                <div class="text">
                    <h3>Search Result</h3>
                    <p><a href="#" title="Home">Home</a><i class="fa fa-caret-right"></i><a href="#" title="Search Result">Search Result</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="products ver2 grid_full hover-shadow furniture">
                <?php
                    ...
                    $query = mysql_query("SELECT * FROM item WHERE item_name LIKE '%$search_query%' OR item_code LIKE '%$search_query%' OR item_brand LIKE '%$search_query%' OR item_color LIKE '%$search_query%' OR item_type LIKE '%$search_query%' OR material LIKE '%$search_query%'");
                    ...
                    <div class="product">
                        ...
                        <div class="product-images">
                            <a href="#" title="product-images">
                                <?php echo '<a class="add-cart" href="products-details.php?id='.$data['item_code'].'"><img class="primary_image" src="admin/'.$data['image'].'" alt=""/></a>'; ?>
                            </a>
                            <div class="action">
