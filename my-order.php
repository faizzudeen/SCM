...
<head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/css/styles7.css"/>
        <link rel="stylesheet" type="text/css" href="assets/vendor/owl-slider.css"/>
        <link rel="stylesheet" type="text/css" href="assets/vendor/settings.css"/>
        <link rel="shortcut icon" href="assets/images/favicon.png" />
        <link href='https://fonts.googleapis.com/css?family=Roboto:400,100,500,700,300' rel='stylesheet' type='text/css'>
        <script type="text/javascript" src="assets/js/jquery-1.11.1.min.js"></script>
        <title>My Order - ANISH Fashion Store</title>
    </head>
    <body>
    ...
    <div class="wrappage">
        ...
        <header id="header" class="header-v3">
         ...
         <div class="container">
            <div class="banner-header banner-lbook3 space-40">
                ...
                <div class="text">
                    <h3>My Order</h3>
                    <p><a href="#" title="Home">Home</a><i class="fa fa-caret-right"></i>My Order</p>
                </div>
            </div>
        </div>
        <div class="container container-ver2">
            <div class="products ver2 grid_full hover-shadow furniture">
                <div class="row ">
                    <div class="col-md-8 col-sm-8 col-xs-12" style="width:1180px;">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                            $bd = $_SESSION['email'];
                                            $query = mysql_query("SELECT * FROM orders WHERE order_user = '$bd'");
                                            while ($data = mysql_fetch_array($query)) {
                                        ?>
                                            <tr>
                                                    <td style="text-align: center;"><?php echo $data['order_id']; ?></td>
                                                    <td style="text-align: center;"><?php echo $data['name']; ?></td>
                                                    <td style="text-align: center;"><?php echo $data['item_code']; ?></td>
                                                    <td style="text-align: center;"><?php echo $data['item_name']; ?></td>
                                                    <td style="text-align: center;"><?php echo $data['item_code']; ?></td>
                                                    <td style="text-align: center;"><?php echo $data['item_qty']; ?></td>
                                                    <td style="text-align: center;"><?php echo $data['total']; ?></td>
                                                    <td style="text-align: center;"><span class="label label-primary"><?php echo $data['status']; ?></span></td>
                                                    <td style="text-align: center;"><?php echo $data['date_order']; ?></td>
                                            </tr>
                                        <?php
                                          }
                                        ?>
