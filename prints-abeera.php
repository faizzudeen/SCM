...
<head>
        ...
        <title>Abeera | Prints - ANISH Fashion Store</title>
    </head>
    <body>
    ...
    <div class="header-top">
        ...
        <div class="container">
            <div class="banner-header banner-lbook3 space-40">
                ...
                <div class="text">
                    <h3>Abeera</h3>
                    <p><a href="#" title="Home">Home</a><i class="fa fa-caret-right"></i><a href="#" title="Prints">Prints</a><i class="fa fa-caret-right"></i>Abeera</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <?php
                        ...
                        $query = mysql_query("SELECT * FROM item WHERE item_brand LIKE 'Abeera'");
