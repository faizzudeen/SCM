...
<head>
        ...
        <title>#AnishRaya2017 - ANISH Fashion Store</title>
    </head>
    <body>
    ...
    <div class="header-top">
                    ...
                    <div class="inner-topbar box">
                        ...
                        <div class="float-right align-right">
                            ...
                            <div class="hover-menu">
                                ...
                                <ul class="list-menu">
                                    <li><a href="login-register.php" title="LOGIN">LOGIN</a></li>
        ...
        <div class="container">
            <div class="banner-header banner-lbook3 space-40">
                ...
                <div class="text">
                    <h3>#AnishRaya2017</h3>
                    <p><a href="#" title="Home">Home</a><i class="fa fa-caret-right"></i>#AnishRaya2017</p>
                </div>
            </div>
        </div>
